...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/17 22:18:13 by jsance            #+#    #+#             */
/*   Updated: 2021/02/17 22:18:14 by jsance           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "parser.h"

t_compound_list	*init_compoumnd_list(void)
{
...
void			set_separator_compound_list(t_compound_list **compound_list,
									...
									t_deque **tokbuf_g)
{
	...
	*compound_lst = init_compoumnd_list();
	...
	{
		if (match_compound_list(&(*compound_lst)->next, tokbuf_g) != 1)
